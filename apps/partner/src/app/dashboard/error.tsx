...
export default function DashboardError({
  ...
  if (isInvalidUuidQueryError(error)) {
    return (
      <DatabaseFallbackCard
        ...
        title="This URL is not a valid lead id"
        message="Open the lead from the Leads list instead of editing the address bar, or ask your admin for the correct link."
        details={devErrorDetails(error)}
        onRetry={reset}
        showConnectionTips={false}
      />
  ...
  return (
    <DatabaseFallbackCard
      eyebrow="Page error"
      title="Partner page failed to render"
