...
export function DatabaseFallbackCard({
  ...
  message = "The admin UI rendered, but it could not reach Postgres. Check DATABASE_URL, confirm the database host resolves locally, and verify your network or VPN before retrying.",
  host,
  retryLabel = "Retry",
  onRetry,
